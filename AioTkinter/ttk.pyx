...
__all__ = ["Button", "Checkbutton", "Combobox", "Entry", "Frame", "Label", "Labelframe", "LabelFrame", "Menubutton", "Notebook", "Panedwindow", "PanedWindow", "Progressbar",
           "Radiobutton", "Scale", "Scrollbar", "Separator", "Sizegrip", "Spinbox", "Style", "Treeview",  # Extensions
           "LabeledScale", "OptionMenu",  # functions
           "tclobjs_to_py", "setup_master"]


from .tk import (BaseWidget, Entry, IntVar, Menu, PanedWindow, Scale, Scrollbar, TclError, Widget as tkWidget, XView, YView, _flatten, _get_default_root, _get_ints, _join,
...
class Style(object):
    ...
    def layout(self, style, layoutspec=None):
        ...
        if layoutspec:
            ...
            lspec = "null"  # could be any other word, but this may make sense  # when calling layout(style) later
...
class Widget(tkWidget):
    ...
    def __init__(self, master: BaseWidget, widgetname: str, kw=None):
        ...
        """
        master = setup_master(master)
        tkWidget.__init__(self, master, widgetname, kw=kw)
...
class Button(Widget):
    ...
    def __init__(self, master: BaseWidget = None, **kw):
...
class Entry(Widget, Entry):
    ...
    def __init__(self, master: BaseWidget = None, widget=None, **kw):
    ...
    def bbox(self, index):
        ...
        return _get_ints(self.tk.call(self._w, "bbox", index))
...
class Panedwindow(Widget, PanedWindow):
    ...
    forget = PanedWindow.forget  # overrides Pack.forget
...
class Scrollbar(Widget, Scrollbar):
...
class Treeview(Widget, XView, YView):
    ...
    def bbox(self, item: str, column: int = None):
        ...
        return _get_ints(self.tk.call(self._w, "bbox", item, column)) or ''

    def get_children(self, item: str = None):
        """Returns a tuple of children belonging to item.

        If item is not specified, returns root children."""
        return self.tk.splitlist(self.tk.call(self._w, "children", item or '') or ())

    def set_children(self, item: str, *new_children):
        """Replaces item's child with newchildren.

        Children present in item that are not present in newchildren
        are detached from tree. No items in newchildren may be an
        ancestor of item."""
        self.tk.call(self._w, "children", item, new_children)
    ...
    def insert(self, parent, index: int, iid=None, **kw):
    ...
    def tag_bind(self, tag_name: str, sequence=None, callback=None):
        """Bind a callback for the given event sequence to the tag tagname.
        When an event is delivered to an item, the callbacks for each
        of the item's tags option are called."""
        self._bind((self._w, "tag", "bind", tag_name), sequence, callback, add=0)

    def tag_configure(self, tag_name: str, option=None, **kw):
        ...
        if option is not None:
            kw[option] = None
        return _val_or_dict(self.tk, kw, self._w, "tag", "configure", tag_name)

    def tag_has(self, tag_name: str, item=None):
        ...
        * Availability: Tk 8.6"""
        if item is None:
            return self.tk.splitlist(self.tk.call(self._w, "tag", "has", tag_name))
        else:
            return self.tk.getboolean(self.tk.call(self._w, "tag", "has", tag_name, item))
...
class LabeledScale(Frame):
    ...
    def __init__(self, master: Widget = None, variable=None, from_=0, to=10, **kw):
        """Construct a horizontal LabeledScale with parent master, a
        variable to be associated with the Ttk Scale widget and its range.
        If variable is not specified, a IntVar is created.
...
class OptionMenu(Menubutton):
    ...
    def __init__(self, master, variable, default=None, *values, **kwargs):
        ...
        *values and additional keywords.
        ...
        """
        kw = {
            'textvariable': variable, 'style': kwargs.pop('style', None), 'direction': kwargs.pop('direction', None)
            }
        ...
        if kwargs:
            raise TclError('unknown option -%s' % (next(iter(kwargs.keys()))))
